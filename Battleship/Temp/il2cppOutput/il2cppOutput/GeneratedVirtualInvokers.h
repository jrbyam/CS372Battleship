...
{
	typedef R (*Func)(void*, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, const MethodInfo*);

	static inline R Invoke (Il2CppMethodSlot slot, void* obj, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10, T11 p11)
	{
		VirtualInvokeData data = il2cpp::vm::Runtime::GetVirtualInvokeData (slot, obj);
		return ((Func)data.methodInfo->method)(data.target, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, data.methodInfo);
	}
};
