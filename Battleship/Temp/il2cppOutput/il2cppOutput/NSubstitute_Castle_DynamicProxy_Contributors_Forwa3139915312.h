...
struct  ForwardingMethodGenerator_t3139915312  : public MethodGenerator_t3295115653
{
public:
	// Castle.DynamicProxy.Contributors.GetTargetReferenceDelegate Castle.DynamicProxy.Contributors.ForwardingMethodGenerator::getTargetReference
	GetTargetReferenceDelegate_t3954391140 * ___getTargetReference_2;

public:
	inline static int32_t get_offset_of_getTargetReference_2() { return static_cast<int32_t>(offsetof(ForwardingMethodGenerator_t3139915312, ___getTargetReference_2)); }
