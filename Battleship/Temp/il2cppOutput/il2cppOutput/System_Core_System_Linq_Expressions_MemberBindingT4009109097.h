...
struct  MemberBindingType_t4009109097 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MemberBindingType_t4009109097, ___value___1)); }
